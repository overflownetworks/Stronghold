...
--Lazy gmod13 conversion, thanks robotboy
FORCE_STRING, FORCE_NUMBER, FORCE_BOOL, FORCE_ENTITY, FORCE_VECTOR, FORCE_ANGLE = 1, 2, 3, 4, 5, 6
local types = {
	[FORCE_STRING] = "String",
	[FORCE_NUMBER] = "Int",
	[FORCE_BOOL] = "Bool",
...
function AccessorFuncNW( tab, varname, name, varDefault, iForce )
	local get, set = "GetNW" .. types[iForce or 2], "SetNW" .. types[iForce or 2]
	tab[ "Set" .. name ] = function( self, v ) self[set](self, varname, v) end
	tab[ "Get" .. name ] = function( self ) return self[get](self, varname, varDefault) end
end
